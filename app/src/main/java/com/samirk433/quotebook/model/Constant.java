...
public class Constant {
    ...
    private static String DESIGNED_BY = "Designed by Sky developers";
    public static String SHARE_CONTENT = "A beautiful app designed with Material Design:\n" + APP_URL + "\n- " + DESIGNED_BY;
    public static String EMAIL = "mailto:muhammadyasir.2551@gmail.com";
    public static String GIT_HUB = "https://github.com";
